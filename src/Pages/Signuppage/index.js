...
function Signupfrompage() {
        ...
        <div className='container my-3'>
          ...
          >
            ...
            <div className="col-sm-6 card-no-border-radius">
              <div className="card main-no-box-shadow" style={{ border: "none" }}>
                <div className="card-body">
                  ...
                  <h1 className="card-title text-start mx-2">Welcome to Jobbooks!</h1>
                  <h4 className="card-title text-start mx-2">Register your account</h4>
  ...
  <path d="M3.35 5.47c-.18.16-.353.322-.518.487A13.134 13.134 0 0 0 1.172 8l.195.288c.335.48.83 1.12 1.465 1.755C4.121 11.332 5.881 12.5 8 12.5c.716 0 1.39-.133 2.02-.36l.77.772A7.029 7.029 0 0 1 8 13.5C3 13.5 0 8 0 8s.939-1.721 2.641-3.238l.708.709zm10.296 8.884-12-12 .708-.708 12 12-.708.708"/>
                  ...
                  <button className="btn btn-outline-success mx-4 recent btn-no-border">
                    login
                  </button>

                  <div className='text-start mx-3 my-4 loginwith'>
                    <h5>Create account with</h5>
                    <button className="btn btn-outline-success mx-2 recent iconstyle btn-no-border" >
                      <img
                        src={Facebook}
